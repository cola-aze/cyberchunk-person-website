...
import { DownloadResumeButton } from './components/ResumeDownload'
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-12">
                        <div className="md:w-1/3">
                            <div className="relative">
                                <div
                                    className="absolute -inset-4 bg-gradient-to-r from-pink-500 to-blue-500 opacity-30 blur-xl rounded-full"/>
                                <div
                                    className="relative w-64 h-64 mx-auto rounded-full overflow-hidden border-2 border-pink-500/50">
                                    <div
                                        className="w-full h-full bg-gradient-to-br from-pink-900/30 to-purple-900/30 flex items-center justify-center">
                                        <div
                                            //https://images.unsplash.com/photo-1566492031773-4f4e44671857?q=80&w=1000
                                            className="absolute inset-0 bg-[url('/userImage/colaAze.jpg')] bg-cover bg-center opacity-80 mix-blend-luminosity"></div>
                                        <div
                                            className="absolute inset-0 bg-gradient-to-br from-pink-600/30 to-purple-900/30"></div>
                                        <div className="absolute inset-0 bg-black opacity-20"></div>
                                        <div className="absolute inset-0 glitch-overlay opacity-10"></div>
                                    </div>
                                </div>
                                <div
                                    className="absolute -inset-1 border-2 border-dashed border-pink-500/30 rounded-full animate-spin-slow"/>
                            </div>
                        </div>
                        <div className="md:w-2/3 space-y-6">
                            <div
                                className="inline-block px-3 py-1 border border-pink-500 text-pink-500 text-xs font-mono rounded-full">
                                开发者 / 设计师 / 数字艺术家
                            </div>
                            <h1 className="text-4xl md:text-5xl font-bold">
                                <span className="block">可乐阿泽</span>
                                <span
                                    className="block text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-blue-500">
                  COLA AZE
                </span>
                            </h1>
                            <p className="text-gray-300 max-w-2xl">
                                我是一名专注于赛博朋克美学的职业开发者和数字艺术家和设计师。我的作品融合了未来主义、复古科技和城市文化元素，创造出独特的视觉体验。通过结合前沿技术和艺术表达，我致力于探索数字时代的新可能性，打造令人惊叹的沉浸式体验。
                            </p>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-4xl mx-auto">
                        <div className="text-center mb-16">
                            <div
                                className="inline-block px-3 py-1 border border-pink-500 text-pink-500 text-xs font-mono rounded-full mb-4">
                                我的旅程
                            </div>
                        ...
                        <div className="space-y-12">
                            ...
                            {[
                                ...
                                <div key={index} className="relative pl-8 md:pl-0">
                                    <div
                                        className="hidden md:block absolute left-1/2 transform -translate-x-1/2 -translate-y-4 w-px h-full bg-gradient-to-b from-pink-500 to-transparent"/>
                                    <div className="flex flex-col md:flex-row md:items-center">
                                        <div className="md:w-1/2 md:pr-12 md:text-right mb-4 md:mb-0">
                                            <div
                                                className="inline-block px-3 py-1 bg-pink-500/10 text-pink-500 text-xs rounded-full mb-2">
                                                {item.period}
                                            </div>
                                        ...
                                        <div
                                            className="hidden md:block absolute left-1/2 top-0 transform -translate-x-1/2 -translate-y-1 w-4 h-4 rounded-full bg-pink-500 border-4 border-black"/>
                                        <div className="md:w-1/2 md:pl-12">
                                            <div className="relative">
                                                <div
                                                    className="absolute -inset-4 bg-gradient-to-r from-pink-500 to-blue-500 opacity-10 blur-md rounded-lg"/>
                                                <div
                                                    className="relative border border-pink-500/30 rounded-lg p-4 bg-black/50 backdrop-blur-sm">
                            ...
                            {[
                                ...
                                <div key={index} className="relative">
                                    <div
                                        className="absolute -inset-4 bg-gradient-to-r from-pink-500 to-blue-500 opacity-10 blur-md rounded-lg"/>
                                    <div
                                        className="relative border border-pink-500/30 rounded-lg p-6 bg-black/50 backdrop-blur-sm h-full">
                                        <div
                                            className="w-12 h-12 rounded-full bg-pink-500/10 flex items-center justify-center mb-4">
                                            {item.icon}
                                        </div>
                                        <div
                                            className="inline-block px-3 py-1 bg-pink-500/10 text-pink-500 text-xs rounded-full mb-2">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[
                                ...
                                <div key={index} className="relative group">
                                    <div
                                        className="absolute -inset-1 bg-gradient-to-r from-pink-500 to-blue-500 opacity-30 blur-sm group-hover:opacity-100 transition-all duration-300 rounded-lg"/>
                                    <div
                                        className="relative border border-pink-500/30 rounded-lg p-6 bg-black/50 backdrop-blur-sm h-full">
